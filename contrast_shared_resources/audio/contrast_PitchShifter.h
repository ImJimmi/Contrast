...
namespace contrast
{
    ...
    public:
        //==============================================================================================================
        PitchShifter(const int maximumDelay, double sampleRate, uint32 blockSize)
            :   maxDelay(static_cast<float>(maximumDelay))
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                delayLine[i].reset(new dsp::DelayLine<float>(maximumDelay));
    ...
    private:
        //==============================================================================================================
        std::unique_ptr<dsp::DelayLine<float>> delayLine[2];
